...
export const Landing = () => {
	...
	return (
		<section id="landing" className="py-44 px-3">
			<main className="max-w-l ">
				...
				<div className="flex items-center justify-center gap-4">
					<h1 className="text-5xl text-gray-50 font-semibold text-accenty ">
						FULLSTACK
					</h1>
				</div>
				<div className="flex justify-between items-center text-center text-[10px] ">
					...
					<div className="relative">
						<div className="relative ml-1 ">
							<Link
								href="mailto:abi.sarangwala@gmail.com"
								linkSymbol={'forward_to_inbox'}
